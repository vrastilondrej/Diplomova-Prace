...
Pro potřeby studie bylo potřeba vybrat předměty, které souvisí s~výukou programování. V prvním kroku byli analyzovány názvy předmětů v získaných studijních programech a na základě toho sestavena  množina klíčových slov, které by se mohla objevit v názvech předmětů, které souvisí s tématem programování a algoritmizace nebo příbuzných tématech. Tato množina obsahovala např. tyto klíčová slova:\begin{displayquote}
