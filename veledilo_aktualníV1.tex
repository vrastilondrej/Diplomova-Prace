...
\todo{???tahle kapitola by potřebovala trochu vyladit a zpřehlednit, algoritmizaci v RVP popsala už ve své diplomové práci Bromová, lepší se odkazovat nebo přepracovat?}
...
Pro potřeby studie bylo potřeba vybrat předměty, které souvisí s výukou programování. Na základě zkoumání složení předmětů v jednotlivých programech bylo zvoleno 5 skupin předmětů, jenž mají souvislost s programováním a algoritmizací.  
\vspace{2mm}\begin{itemize}[nosep]
...
\footnotesize
\center
    \begin{tabular}{L{2cm} L{4cm} L{1cm} L{4cm}}
...
JU & Přírodovědecká fakulta&NMgr.&?\\ \hline
MUNI & Přírodovědecká fakulta&Bc.&Informatika a druhý obor \\ 
MUNI & Přírodovědecká fakulta&NMgr.&Učitelství informatiky pro střední školy\\ \hline
...
UTB&?&NMgr.&Učitelství informatiky pro střední školy\\
