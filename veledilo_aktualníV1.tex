...
Metodikou popsanou výše bylo získáno a kategorizováno 
...
\label{my-label}
\begin{threeparttable}
\begin{tabular}{C{1cm}C{1cm}C{0.7cm}C{0.7cm}C{0.7cm}C{0.7cm}C{0.7cm}C{0.8cm}C{0.7cm}C{0.7cm}C{0.7cm}C{0.7cm}C{0.7cm}C{0.7cm}}
\toprule
&PedF
JU & PřF JU & FI MU & PřF OU &FP TUL ZŠ&FP TUL SŠ& PedF UHK ZŠ& PedF UHK SŠ & MFF UK & PedF UK & PřF UP & FAI UTB& PedF ZČU \\  \midrule
VP	&0       &0   &0   &0     &2       &2  &0  &0       &0      &0       &0    &1  &0      \\ 
VA	&1       &0   &0   &0     &1       &0  &0   &1       &1      &0      &2    &0  &0     \\ 
DP	&2       &3   &2   &1     &1       &2   &0   & 0       &2    &1       & 1    &2  &2      \\ 
WWW	&0       &0   &0   &0     &1       &1   &0  & 0       &1      &0      & 0    &1  &0     \\ \midrule
celk.&4       &5   &6   &3   &4       &4   &6   & 4       &6      &4       & 7    &5  &1      \\  \bottomrule
\end{tabular}
\begin{tablenotes}\footnotesize
\item[1] možnost z výběru dvou programovacích jazyků
\item[2] možnost z výběru tří programovacích jazyků
