...
\begin{threeparttable}
\tabcolsep=0.13cm
\begin{tabular}{C{1cm}C{0.7cm}C{0.6cm}C{0.6cm}C{0.6cm}C{0.6cm}C{0.6cm}C{0.7cm}C{0.7cm}C{0.7cm}C{0.7cm}C{0.6cm}C{0.7cm}|>{\columncolor[gray]{.95}[0pt]}C{0.7cm}>{\columncolor[gray]{.95}[0pt]}C{0.7cm}}
\toprule
&PedF
...
1 & VP  & \cellcolor{red!5}       & 2      & 3     & 1      & 2       & 3        & 3       & 2        & 4      & 2       & 4      & 2        \\  
  & VA       &\cellcolor{blue!5}         &        &       &        &         &          &         &          &        &         &        &          \\ 
  & DP       &         &        &       &        &         &          &         &          &        &         &        &          \\  
  & WWW  &         &        &       &        &         &          &         &          &        &         &        &          \\ \midrule
2 & VP       &         &        &       &        &         &          &         &          &        &         &        &          \\
  ...
  & DP        &         &        &       &        &         &          &         &          &        &         &        &          \\
  & WWW &         &        &       &        &         &          &         &          &        &         &        &         \\
1 & VP  & \cellcolor{red!5}1       & 2      & 3     & 1      & 2       & 3        & 3       & 2        & 4      & 2       & 4      & 2        \\ \cmidrule(l){3-14} 
  & VA       &         &        &       &        &         &          &         &          &        &         &        &          \\ \cmidrule(l){3-14} 
  & DP       &         &        &       &        &         &          &         &          &        &         &        &          \\ \cmidrule(l){3-14} 
  & WWW  &\cellcolor{green!5}     &        &       &        &         &          &         &          &        &         &        &          \\ \midrule
2 & VP       &         &        &       &        &         &          &         &          &        &         &        &          \\
  & VA        &         &        &       &        &         &          &         &          &        &         &        &          \\
  & DP        &         &        &       &        &         &          &         &          &        &         &        &          \\
  & WWW &         &        &       &        &         &          &         &          &        &         &        &         \\
...
\hline
  &     & PedF JU & PřF JU & FI MU & PřF OU & PedF OU & FP TUL ZŠ & FP TUL SŠ & PřF UHK ZŠ & PřF UHK SŠ & PřF UJEP & MFF UK & PedF UK & PřF UP & FAI UTB & PedF ZČU \\ \hhline{*{17}{-}}
1 & VP  &  1       & 2      &\cellcolor{red!50}      & 1      & 2       & \cellcolor{red!50}&\cellcolor{red!50}           &            & 3          &  \cellcolor{red!50} & 4      & 2       &\cellcolor{red!50}    &         & 2        \\   
  & VA  &           &        &  \cellcolor{green!50}     &  \cellcolor{green!50}      &  \cellcolor{green!50}        &           &           &           \cellcolor{green!50} &   \cellcolor{green!50}         & \cellcolor{green!50}         &  \cellcolor{green!50}       &         &        &         &          \\ 
  & DP  &         &        &       &        &        &           &           &            &            &          &        &         &        &         &          \\ 
  & WWW &         &        &       &        &         &           &           &            &            &          &        &         &        &         &          \\ \hhline{*{17}{-}}
2 & VP  & \cellcolor{red!50}         &        &       &        &         & \cellcolor{red!50}          &   \cellcolor{red!50}         &\cellcolor{red!50}             &  \cellcolor{red!50}   &\cellcolor{red!50}          &   \cellcolor{red!50}     &  \cellcolor{red!50}        &  \cellcolor{red!50}      &         &          \\ 
  & VA  &  \cellcolor{green!50}       &        &    \cellcolor{green!50}   & \cellcolor{green!50}       &     \cellcolor{green!50}     &           \cellcolor{green!50}    &\cellcolor{green!50}           &            &            &          &\cellcolor{green!50}         &         &        &         &          \\ 
  & DP  &         &        &       &        &        &           &           &            &            &          &        &         &        &         &          \\  
  & WWW &         &        &       &        &         &           &           &            &            &          &        &         &        &         &      \\   \hhline{*{17}{-}}
3 & VP  &         &        &\cellcolor{red!50}2       &  \cellcolor{red!50}      &         &           &           &            &            &          &  \cellcolor{red!50}      & \cellcolor{red!50}         &   \cellcolor{red!50}     &         &          \\  
  & VA  &         &        &\cellcolor{green!50}&        &     \cellcolor{green!50}     &           &           &            &            &          &\cellcolor{green!50}          &        &\cellcolor{green!50}       &         &          \\  
  & DP  &         &        &       &        &         &           &           &    \cellcolor{blue!50}        &  \cellcolor{blue!50}          &          &        &         &        &         &          \\  
  & WWW &         &        &       &        &         &           &           &            &            &          &        &         &        &         &      \\    \hhline{*{17}{-}}
4 & VP  &         &        &       &        &         &           &           & \cellcolor{red!50}          &  \cellcolor{red!50}          &          & \cellcolor{red!50}       &  \cellcolor{yellow!50}         &  \cellcolor{red!50}      &         &          \\  
  & VA  &         &        &       &        &         &           &           & \cellcolor{green!50}              &  \cellcolor{green!50}             & \cellcolor{green!50}         &        &         &   \cellcolor{green!50}     &         &          \\  
  & DP  &         &        &       &        &         &           &           &            &            &          &        &         &        &         &          \\  
  & WWW &         &        &       &        &  \cellcolor{yellow!50}       &           &           &            &            &          &        &         &        &         &      \\    \hhline{*{17}{-}}
5 & VP  &         &        &       &        &         &           &           &            &            &          &        &         &        &         &          \\
  & VA  &         &        &       &        &         &           &           &            &            &          &        &         &  \cellcolor{green!50}      &         &          \\
  & DP  & \cellcolor{blue!50}        &        &       &        &         &           &           &            &            &          &        &         &        &         &          \\
  & WWW &         &        &       &        &         &           &           &            &            &          &        &         &        &         &      \\   \hhline{*{17}{-}}
6 & VP  &         &        &       &        &         &  \cellcolor{red!50}         & \cellcolor{red!50}           &            &            &          &        &         &        &         &          \\
  & VA  &         &        &       &        &         &           &           &            &            &          &        &         &        &         &          \\
  & DP  &   \cellcolor{blue!50}      &        &       &        &         &           &           &            &            &          &        &  \cellcolor{blue!50}       &        &         &          \\
  & WWW &         &        &       &        &         &           &           &  \cellcolor{yellow!50}          &  \cellcolor{yellow!50}          &          &        &         &        &         &      \\    \hhline{*{17}{=}}
7 & VP  &         &        &       &        &  x       & \cellcolor{red!20} 2         &   \cellcolor{red!20}2        &            &            &          &        &         &        &         &          \\
  & VA  &         &        &       &        & x        & \cellcolor{green!20}          &           &            &  \cellcolor{green!50}           &           &        &         & \cellcolor{green!50}          &         &          \\
  & DP  &  \cellcolor{blue!50}       &        &       &        &  x       & \cellcolor{blue!20}           &   \cellcolor{blue!20}2         &            &            &          &\cellcolor{blue!20} 2       &         &        &         &          \\
  & WWW &         &        &       &        & x        &\cellcolor{yellow!20}           &   \cellcolor{yellow!20}        &            &            &          & \cellcolor{yellow!50}        &         &        &         &      \\    \hhline{*{17}{-}}
8 & VP  &         &        &       &        & x        &           &           &            &            &          &        &         &        &         &          \\
  & VA  &         &        &       &        & x        &           &           &            &            &          &        &         &\cellcolor{green!50}           &         &          \\
  & DP  &         &        &\cellcolor{blue!50}       &  \cellcolor{blue!50}      &    x     &           &           &            &            &          &        & \cellcolor{blue!50}        &  \cellcolor{blue!50}       &         &          \\
  & WWW &         &        &       &        & x        &           &           &            &            &          &        &         &        &         &      \\   \hhline{*{17}{-}}
9 & VP  &         &        &       &        &   x      &           &           &            &            &          &        &         &        &         &          \\
  & VA  &\cellcolor{green!50}             &        &       &        &x         &           &           &            &            &          &  \cellcolor{green!50}       &         &        &         &          \\
  & DP  &\cellcolor{blue!50}         &        & \cellcolor{blue!50}      &        & x        &           &           &            &            &          &        &         &        &         &          \\
  & WWW &         &        &       &        &        x &           &           &            &            &          &        &         &        &         &      \\    \hhline{*{17}{-}}
\multirow{4}{*}[-0.01em] {10}  & VP  &         &        &       &        &        x &           &           &            &            &          &        &         &        &         &          \\
  & VA  &         &        &       &        &         x&           &           &            &            &          &        &         &        &         &          \\
  & DP  &         &        &       &        &        x &           &           &            &            &          &        &         &        &         &          \\
  & WWW &         &        &       &        & x        &           &           &            &            &          &        &         &        &         &      \\    \bottomrule
\end{tabular}
